...
class Uri
{
  ...
  public function checkUser($username = null)
  {
    ...
    if($status === FALSE)
    {
      throw new Helper\Exception("URI username validation failed");
    }
  ...
  {
    return ($this->hasPath()) ? new Helper\String($this->path) : $default;
  }
  ...
  public function checkQuery($query = null)
  {
    ...
    if($status === FALSE)
    {
      throw new Helper\Exception("URI query string validation failed");
    }
  ...
  public function checkFragment($fragment = null)
  {
    ...
    if($status === FALSE)
    {
      throw new Helper\Exception("URI fragment validation failed");
    }
  ...
  {
    return ($this->hasFragment()) ? new Helper\String($this->fragment) : $default;
  }
  ...
  {
    $scriptPath = new Helper\String(dirname(self::getHostParam("SCRIPT_NAME")));

...
class TCP extends TS3Abstract
{
  ...
  public function connect()
  {
    ...
    {
      throw new \TeamSpeak3\Transport\Exception(\TeamSpeak3\Helper\String::factory($errstr)->toUtf8()->toString(), $errno);
    }
  ...
  public function disconnect()
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit(strtolower($this->getAdapterType()) . "Disconnected");
  }
  ...
  public function read($length = 4096)
  {
    ...
    return new \TeamSpeak3\Helper\String($data);
  }
  ...
  public function send($data)
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit(strtolower($this->getAdapterType()) . "DataSend", $data);
  }

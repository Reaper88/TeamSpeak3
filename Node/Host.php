 ...
 */
class Host extends TS3Abstract
{
  /**
   * @ignore
   */
   ...
   */
  public function __construct(\TeamSpeak3\Adapter\ServerQuery $squery)
  {
    $this->parent = $squery;
  }
  ...
  public function serverSelect($sid, $virtual = null)
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyServerselected", $this);
  }
  ...
  public function serverGetPortById($sid)
  {
    ...
    {
      throw new \TeamSpeak3\Adapter\ServerQuery\Exception("invalid serverID", 0x400);
    }
  ...
  {
    $parts = \TeamSpeak3\Helper\Uri::getFQDNParts($tsdns);
    $query = \TeamSpeak3\Helper\String::factory(array_shift($parts));
    ...
    while($part = array_shift($parts))
    {
      ...
      catch(\TeamSpeak3\Transport\Exception $e)
      {
    ...
    throw new \TeamSpeak3\Adapter\erverQuery\Exception("invalid serverID", 0x400);
  }
  ...
  public function serverCreate(array $properties = array())
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyServercreated", $this, $detail["sid"]);
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyTokencreated", $server, $detail["token"]);
  ...
  public function serverDelete($sid)
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyServerdeleted", $this, $sid);
  }
  ...
  public function serverStart($sid)
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyServerstarted", $this, $sid);
  }
  ...
  public function serverStop($sid)
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyServerstopped", $this, $sid);
  }
  ...
  {
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyServershutdown", $this);
  ...
  public function permissionList()
  {
    ...
    foreach($this->permissionList as $permname => $permdata)
    {
      ...
      if(!$permdata["permname"]->startsWith("i_needed_modify_power_") && !isset($this->permissionList[$grantsid]))
      {
        ...
        $this->permissionList[$grantsid]["permname"]  = \TeamSpeak3\Helper\String::factory($grantsid);
  ...
  public function permissionGetIdByName($name)
  {
    ...
    {
      throw new \TeamSpeak3\Adapter\ServerQuery\Exception("invalid permission ID", 0xA02);
    }
  ...
  public function permissionGetNameById($permid)
  {
    ...
    {
      if($perm["permid"] === $permid) return new \TeamSpeak3\Helper\String($name);
    }
  ...
  public function login($username, $password)
  {
    ...
    $crypt = new \TeamSpeak3\Helper\Crypt($username);

    $this->setStorage("_login_user", $username);
    $this->setStorage("_login_pass", $crypt->encrypt($password));

    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyLogin", $this);
  }
  ...
  public function logout()
  {
    ...
    \TeamSpeak3\Helper\Signal::getInstance()->emit("notifyLogout", $this);
  }

 ...
 */
class Channelgroup extends TS3Abstract
{
  /**
  ...
  public function __construct(Server $server, array $info, $index = "cgid")
  {
    ...
    {
      throw new \TeamSpeak3\Adapter\ServerQuery\xception("invalid groupID", 0xA00);
    }
  ...
  public function message($msg)
  {
    foreach($this as $client)
    {
      ...
      catch(\TeamSpeak3\Adapter\ServerQuery\Exception $e)
      {

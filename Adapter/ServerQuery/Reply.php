...
class Reply
{
   ...
   */
  public function __construct(array $rpl, $cmd = null, \TeamSpeak3\Node\Host $con = null, $exp = TRUE)
  {
    $this->cmd = new \TeamSpeak3\Helper\String($cmd);
    $this->con = $con;
    $this->exp = (bool) $exp;
  ...
  protected function fetchReply($rpl)
  {
    ...
    $this->rpl = new \TeamSpeak3\Helper\String(implode(TeamSpeak3::SEPARATOR_LIST, $rpl));
  }
}

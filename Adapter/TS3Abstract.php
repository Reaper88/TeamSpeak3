...
abstract class TS3Abstract
{
   ...
   * @return void
   */
  protected function initTransport($options, $transport = "\TeamSpeak3\Transport\TCP")
  {
    if(!is_array($options))
    {
      throw new TeamSpeak3\Adapter\Exception("transport parameters must provided in an array");
    }
